...
| 이름   | 담당 업무                                                    | Github                          |
| :----- | ------------------------------------------------------------ | ------------------------------- |
| 이상훈 | \- 프론트엔드(20%) / 백엔드(80%)<br />\- DB 모델링, 백엔드 데이터 로직 작성 | https://github.com/HOONTP       |
| 황호철 | - 프론트엔드(80%) / 백엔드(20%)<br />- 프론트엔드 기능 구현 및 디버깅, 테스트 | https://github.com/HocheolHwang |
...
기능에 대한 학습을 할 때보다 프로젝트를 진행하며 배운 부분이 굉장히 많았고 결과를 만들어가는 재미가 있었다.

또한 Front와 Back이 할 수 있는 역할이 다르고 효율적으로 기능을 구현할 수 있는 부분이 다르다는 것이 재미있었다.
